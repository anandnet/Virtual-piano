    ...
    BoxLayout:
        BoxLayout:
            ...
            MDLabel:
                ...
                color:1,1,1,1#theme.get_color(app.theme_cls.theme_style,"PrimaryTextColor")
                text:root.text
        BoxLayout:
            Widget:
            DropItem:
                size_hint_x:None
                width:"170dp"
                icon_color:1,1,1,1#theme.get_color(app.theme_cls.theme_style,"PrimaryTextColor")
                icon:"chevron-down"
                id: dropdown_item
                text: "None"
                transparent:True
...
<MusicMapping>:
    AnchorLayout:
        ...
        canvas:
            Color:
                rgba:1,1,1,0#theme.get_color(app.theme_cls.theme_style,"BackgroundColor")
            Rectangle:
                pos:self.pos
                size:self.size
...
class MusicMapping(BoxLayout):
    ...
    def add_mapping_table(self, *args):
        ...
        lh_current_map = mapped_data["piano"][0]
        rh_current_map = mapped_data["piano"][1]
